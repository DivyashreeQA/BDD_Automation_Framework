...
public class PageActions {
	...
	public void enterUserName() {
		...
		waitForElement(ele);
		currentDriver.findElement(ele).sendKeys("divyashreetest@gmail.com");
...
public void enterPassword() {
		...
		currentDriver.findElement(By.xpath("//input[@id='passwd']")).sendKeys("Framework");
...
public void editFirstName() {
	...
	currentDriver.findElement(ele).sendKeys("Divya");
	
	By passEle = By.xpath("//input[@id='old_passwd']");
	waitForElement(ele);
	currentDriver.findElement(passEle).sendKeys("Framework");
